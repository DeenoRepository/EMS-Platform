...
По одному коммиту, тот же рецепт. C6.1 inventory актуализирован; C6.2a, C6.3 и C6.5 завершены:
...
8. **B3, B4, C1–C5, C6.2a, C6.3 и C6.5 завершены.** Следующий этап — C6.6: следующий P1/F-grade bounded файл.
