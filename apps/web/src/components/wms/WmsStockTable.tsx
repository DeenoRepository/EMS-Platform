...
function ZoneCell({ row, canEdit, onOpenLocation }: { row: StockRow; canEdit: boolean; onOpenLocation: (row: StockRow) => void }) {
  if (row.cellCode) {
    return (
          ...
          return (
            ...
            >
              ...
              {visibleColumns.includes('zone') && (
                <TableCell>
                  <ZoneCell row={row} canEdit={canEdit} onOpenLocation={onOpenLocation} />
                </TableCell>
              )}
